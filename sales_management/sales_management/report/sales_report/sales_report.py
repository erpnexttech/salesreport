...
def get_conditions(filters):
    ...
    conditions += get_sales_invoice_item_field_condition(
        "mode_of_payments", "Sales Invoice Payment")
...
def get_cost_center(doctype, txt, searchfield, start, page_len, filters):
    ...
    return frappe.db.sql("""select name from `tabCost Center` where company='{0}' {1}""".format(filters.get("company"), cond))
